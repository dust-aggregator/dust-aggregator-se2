const UserActionBoxContainer2 = ({ children }: any) => {
  return (
    <div className="relative w-[313px] h-[354px]">
      ...
      <div className="w-full h-full flex justify-center items-center mt-1">
        <div
          className="flex-column w-[300px] h-[357px] bg-no-repeat bg-center bg-contain z-20 pl-6 pt-6"
...
export default UserActionBoxContainer2;
