  ...
  return (
    <div className="min-h-0 py-5 px-1 mb-11 lg:mb-0">
      ...
      <div className="w-full flex justify-center">
        {/* ====================>>>>> delete max-w- !! */}
        <div className="w-full max-w-[500px] flex flex-col justify-center items-center relative">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex justify-end z-20">
            ...
            >
              <Image
                src={open ? closeSVG : openSVG}
                alt="toggle nav"
                className="ml-[25%] mt-[15%] h-[35%]"
              />
            </button>
          ...
          <div className={
            `absolute bottom-0 translate-y-full transition-all duration-700 ease origin-top
                ${open ? "scale-y-1" : "scale-y-0 opacity-0"} 
                w-[96%] flex justify-center z-0`
          }>
            {open &&
              <div className="w-[80%] px-[10%] pb-[5%] pt-[15%] bg-gradient-radial from-[#6D675E] to-[#36312B] 
